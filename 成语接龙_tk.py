...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        #设置MainProgramRunning变量，还原里要用到
        self.MainProgramRunning=False
        self.tips=0
...
if __name__ == "__main__":
    ...
    logger.info('成语接龙tk版本 2.0.0 开发版本')
